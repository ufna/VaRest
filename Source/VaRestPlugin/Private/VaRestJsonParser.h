...
{
public:
	FJsonValueNonConstArray(const TArray<TSharedPtr<FJsonValue>>& InArray) : FJsonValueArray(InArray) {}
...
{
public:
	FJsonValueNonConstBoolean(bool InBool) : FJsonValueBoolean(InBool) {}
...
{
public:
	FJsonValueNonConstString(const FString& InString) : FJsonValueString(InString) {}
...
{
public:
	FJsonValueNonConstNumber(double InNumber) : FJsonValueNumber(InNumber) {}
